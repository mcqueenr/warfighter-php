	...
	<link rel="stylesheet" href="https://www.agc.army.mil/Desktopmodules/SharedLibrary/Plugins/font-awesome5/css/all.min.css">
	...
	<script type="text/javascript">
		...
		var speed1 = Number('<?php echo $qUserStory["speed1"]; ?>')*1000;
		var speed2 = Number('<?php echo $qUserStory["speed2"]; ?>')*1000;
		var speed3 = Number('<?php echo $qUserStory["speed3"]; ?>')*1000;
		var speed4 = Number('<?php echo $qUserStory["speed4"]; ?>')*1000;
...
================================================== -->
	<script type="text/javascript">
		$(document).ready(function(){
			if(getCurentFileName()=='index.php' || getCurentFileName()==''){
