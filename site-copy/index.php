...
?>
	...
	<div id="about">
		...
		<div id="about-what-we-do">
			<div class="container container-mission">
				...
				<?php
				$ace_nav_sql = "SELECT * FROM tbl_ace_nav WHERE menuParent = 0 ";
				$result = mysqli_query($conn, $ace_nav_sql);
				...
				<?php
				foreach($qParentMenu as $row){
					if($row['menuName'] == 'SUPPORT'){
						$href 			= 'mailto:dll-wsd-reachback@usace.army.mil';
						$onClick		= '';
						$imageSrc 		= 'images/question-circle-solid.svg';
						$one_third_para = 'WSD provides geospatial, time sensitive, reach-back solutions to
						the DoD and Army in support current, planned or crisis support operations.';
					} else {
						$href 			= 'javascript:void(0);';
						$onClick		= 'onclick="myFunction(this)"';

						if($row['menuName'] == 'BUCKEYE'){
							$imageSrc 		= 'images/plane-solid.svg';	
							$one_third_para 	= 'WSD collects, processes, stores and disseminates Unclassified BuckEye HR3D EO & Lidar data in all
							COCOMs.';
						} else if($row['menuName'] == 'FOUNDATION DATA'){
							$imageSrc 		= 'images/layer-group-solid.svg';
							$one_third_para = 'WSD provides critical mission specific GEOINT data and technical support to the operating and
							generating force.';

						} else if($row['menuName'] == 'GEOSERVICES'){
							$imageSrc 		= 'images/globe-americas-solid.svg';
							$one_third_para = 'WSD ensures that geospatial mission specific Standard, Sharable, Geospatial Foundation (SSGF)
							data is available in theater through web services such as CMB, AGE Web Portal and interactive
							applications.';

						} else if($row['menuName'] == 'MISSION AREAS'){
							$imageSrc 		= 'images/map-marked-alt-solid.svg';
							$one_third_para = 'WSD fills the geospatial requirement gap between the Army and NGA
					...
					<div class="one-third column" data-scrollreveal="enter left and move 150px over 1s">
						<div class="icon-left1">
							<div class="topnav" style="background: inherit;">
								...
								<a href="<?php echo $href; ?>" <?php echo $onClick; ?> style="padding-left: 8px;padding-top: 18px;">
									<img src="<?php echo $imageSrc; ?>" width="20px">
									<h5 style="padding-left: 10px !important;" class="cls_text_search"><?php echo $row['menuName']; ?></h5> &nbsp;
									<i class="fas fa-angle-double-down" style="font-size: 20px;" id="fa_arrow"></i>
								</a>

								<?php
								$sub_ace_nav_sql = "SELECT a.*, fnStripTags(a.menuName) as column_order FROM tbl_ace_nav a
												WHERE a.menuParent = ".$row['recordID']."  
												ORDER by column_order";
								$sub_result = mysqli_query($conn, $sub_ace_nav_sql);
								
								$qChildMenu = array();
								while ($row = mysqli_fetch_array($sub_result, MYSQLI_ASSOC)) {
									$qChildMenu[] = $row;
								}
								?>
		
								<?php
								if(sizeof($qChildMenu)>0){
								?>
									<div id="myLinks">
										<?php foreach($qChildMenu as $child)
										{
										?>
											<a class="frame cls_text_search" href="<?php echo $child['menuHref']; ?>" target="_blank"><?php echo $child['menuName']; ?></a>
										<?php
										}
										?>	
									</div>
						...
						<p class="cls_text_search"><?php echo $one_third_para; ?></p>
					</div>
					<?php
				}
				?>
	...
	<div id="sep1">
		...
		<div class="slideshow" id="slideshow">
			<ol class="slides">
				<li class="current" onclick="openClick('fly-thrus.php');" style="cursor:pointer">
					...
					<div class="tiltview col">
						<a href="fly-thrus.php" style="color: white" target="_blank">
							<img src="images/flythru.png" alt="" />
						</a>
					</div>
				</li>
				<li onclick="openClick('geoglobe.php');" style="cursor:pointer">
					<div class="description">
					...
					<div class="tiltview col">
						<a href="geoglobe.php" target="_blank"><img src="images/GLOBE.png?ver=1" alt="" width="400"
								height="400" /></a>
					</div>
				</li>
				<li onclick="openClick('gts.php');" style="cursor:pointer">
					<div class="description">
					...
					<div class="tiltview col">
						<a href="gts.php" target="_blank"><img src="images/gts1.png" alt="" /></a>
					</div>
				</li>
				<li onclick="openClick('rbs.php');" style="cursor:pointer">
					<div class="description">
					...
					<div class="tiltview col">
						...
						<a href="rbs.php" target="_blank"><img src="images/REACHBACK.jpg" alt="" /></a>
					</div>
				</li>
			</ol>
		</div><!-- /slideshow -->
	...
	<div id="work">
		...
		<ul class="portfolio-wrap">
			<li class="portfolio-box imagery" style="height:240px;">
				...
				<div id="divForm" style="display:none" onclick="open_details('hr3d.php')">
			...
			<li class="portfolio-box data products" style="height:240px;">
				...
				<div id="divForm1" style="display:none" onclick="open_details('ers.php')">
			...
			<li class="portfolio-box products support" style="height:240px;">
				...
				<div id="divForm2" style="display:none" onclick="open_details('hpa.php')">
			...
			<li class="portfolio-box data products" style="height:240px;">
				...
				<div id="divForm3" style="display:none" onclick="open_details('hr3d.php')">
			...
			<li class="portfolio-box data products" style="height:240px;">
				...
				<div id="divForm4" style="display:none" onclick="open_details('utp.php')">
			...
			<li class="portfolio-box imagery" style="height:240px;">
				...
				<div id="divForm5" style="display:none" onclick="open_details('aio.php')">
			...
			<li class="portfolio-box data services" style="height:240px;">
				...
				<div id="divForm6" style="display:none" onclick="open_details('cmb.php')">
			...
			<li class="portfolio-box data services support" style="height:240px;">
				...
				<div id="divForm9" style="display:none" onclick="open_details('3dgeov.php')">
			...
			<li class="portfolio-box products services" style="height:240px;">
				...
				<div id="divForm11" style="display:none" onclick="open_details('3dprm.php')">
			...
			<li class="portfolio-box support" style="height:240px;">
				...
				<div id="divForm16" style="display:none" onclick="open_details('mst.php')">
				...
				<div class="four columns">
					<div class="facts-wrap">
						<div class="facts-wrap-num">
							<span class="counter1"><?php echo $qUserStory["count1"]; ?></span>
						</div>
						<h5>
							<?php echo $qUserStory["label1"]; ?>
						</h5>
					</div>
				</div>
				<div class="four columns">
					<div class="facts-wrap">
						<div class="facts-wrap-num">
							<span class="counter2"><?php echo $qUserStory["count2"]; ?></span>
						</div>
						<h5>
							<?php echo $qUserStory["label2"]; ?>
						</h5>
					</div>
				</div>
				<div class="four columns">
					<div class="facts-wrap">
						<div class="facts-wrap-num">
							<span class="counter3"><?php echo $qUserStory["count3"]; ?></span>
						</div>
						<h5>
							<?php echo $qUserStory["label3"]; ?>
						</h5>
					</div>
				</div>
				<div class="four columns">
					<div class="facts-wrap">
						<div class="facts-wrap-num">
							<span class="counter4"><?php echo $qUserStory["count4"]; ?></span>
						</div>
						<h5>
							<?php echo $qUserStory["label4"]; ?>
						</h5>
					</div>
				</div>
			</div>
