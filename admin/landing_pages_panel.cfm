...
<cfif structkeyexists(FORM,'update_page') and FORM.id NEQ ''>
	<cfquery name="UpdateLandingPage" datasource="warfightersupport">
...
<cfif structkeyexists(FORM,'add_page')>
	...
	<cfquery name="SaveLandingPage" datasource="warfightersupport">
...
<cfif structkeyexists(URL,'action') and URL.action EQ 'delete'>
	<cfquery name="deleteLandingPage" datasource="warfightersupport">
		DELETE FROM tbl_landing_pages
		WHERE id = <cfqueryparam value="#URL.id#" cfsqltype="cf_sql_integer">
	</cfquery>
	<cfset updateFlag = true />
</cfif>
<cfquery datasource="warfightersupport" name="get_landing_pages">
...
<cfif structKeyExists(URL, 'id') and URL.id neq ''>
	<cfquery datasource="warfightersupport" name="qGetPage">
		SELECT * FROM tbl_landing_pages  
		WHERE id  = <cfqueryparam value="#URL.id#" cfsqltype="cf_sql_integer">                    
	</cfquery>
