...
<cfif structkeyexists(FORM,'add_users') and FORM.id EQ '' and structkeyexists(URL,'action') EQ 'NO'>
	...
	<cfquery name="SaveOrgUsers" datasource="warfightersupport">
...
<cfif structkeyexists(URL,'action') and URL.action EQ 'edit'>
	...
	<cfquery datasource="warfightersupport" name="qGetUser">
		SELECT * FROM users
...
<cfquery name="GetBranches" datasource="warfightersupport">
