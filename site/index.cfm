...
$user_story_sql = "SELECT top 1 * FROM user_story";
			...
			<div class="container z-index">
				<div class="four columns">
					<div class="facts-wrap">
						...
						<h5>
							<cfoutput><?php echo $qUserStory["label1"]; ?></cfoutput>
						</h5>
					</div>
				</div>
				<div class="four columns">
					<div class="facts-wrap">
						...
						<h5>
							<cfoutput><?php echo $qUserStory["label2"]; ?></cfoutput>
						</h5>
					</div>
				</div>
				<div class="four columns">
					<div class="facts-wrap">
						...
						<h5>
							<cfoutput><?php echo $qUserStory["label3"]; ?></cfoutput>
						</h5>
					</div>
				</div>
				<div class="four columns">
					<div class="facts-wrap">
						...
						<h5></h5>
							<cfoutput><?php echo $qUserStory["label4"]; ?></cfoutput>
						</h5>
					</div>
				</div>
			</div>
